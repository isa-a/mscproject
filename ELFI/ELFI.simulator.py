...
#wrap create
def tauWrapper(t, X, N, K, r, alpha1, alpha2, alpha3, alpha4, alpha5, alpha6, tau, measurement_times,
                batch_size=1, random_state=None):

    alpha = np.array([[1, alpha1, alpha2], [alpha3, 1, alpha4], [alpha5, alpha6, 1]])
...
alphaprior3 = elfi.Prior(ss.uniform, 0, 5)
alphaprior4 = elfi.Prior(ss.uniform, 0, 5)
alphaprior5 = elfi.Prior(ss.uniform, 0, 5)
alphaprior6 = elfi.Prior(ss.uniform, 0, 5)

vectorized_sim = elfi.tools.vectorize(tauWrapper, [0, 1, 2, 3, 4, 11, 12])

simulator_results = elfi.Simulator(vectorized_sim, t, X, N, K, r, alphaprior1, alphaprior2, alphaprior3, alphaprior4, alphaprior5, alphaprior6,
                    tau, measurement_idx,
