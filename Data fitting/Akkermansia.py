...
tau = 0.01
X = [round(0.00017064*(10**5)), round(0.00015848*(10**5))]
K = [round(3.2082*(10**5)), round(1.9879*(10**5))] # carrying capacities
...
Pops = np.array([[0.00017064,	0.0040678,	0.023875,	0.023706,	0.081055,	0.031941,	0.070163,	1.8389,	1.7067],
                              [0.00015848, 0.00018786,	0.0000487,	0.0000464,	0.00095807,	0.00021153,	0.00014287,	0.0004099	, 0.00042039]])
Pops = Pops*(10**5)
